...
contract LaunchPoolTest is ImpactStableCreditTest {
    ...
    function testSetLaunchExpiration() public {
        changePrank(deployer);
        launchPool.setLaunchExpiration(block.timestamp + 60 days);
        assertEq(launchPool.launchExpiration(), block.timestamp + 60 days);
    }
